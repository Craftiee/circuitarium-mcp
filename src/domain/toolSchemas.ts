...
export const CapabilitiesDataSchema = z.object({
  ...
  portableRunRecord: z.object({
    schemaVersion: z.literal("electronics.run-record/0.1"),
    validationTool: z.literal("electronics_validate_run_record"),
    schemaResource: z.literal("circuitarium://schemas/run-record/0.1"),
    authenticity: z.literal("unsigned-unverified"),
