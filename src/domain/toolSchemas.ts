...
export const CrumbAnalysisDataSchema = z.object({
  ...
  disclosure: z.object({
    ...
    limits: z.object({
      ...
      unknownPayloadKeysPerComponent: z.literal(
        MAX_UNKNOWN_PAYLOAD_KEYS_RETURNED_PER_COMPONENT,
      ),
      ...
      cruTextNodeCharacters: z.literal(MAX_CRU_TEXT_NODE_CHARACTERS),
      cruMarkupDelimiters: z.literal(MAX_CRU_MARKUP_DELIMITERS),
      cruDocumentCharacters: z.literal(MAX_CRU_DOCUMENT_CHARACTERS),
    }),
  }),
});
...
const CrumbProfileAssessmentSchema = z.object({
  status: z.enum([
...
const CrumbRootObservationSchema = z.object({
...
const CrumbComponentChangeSchema = z.object({
  componentId: z.string(),
...
export const CrumbComparisonDataSchema = z.object({
  ...
  componentChanges: z
    .array(CrumbComponentChangeSchema)
    .max(200)
    .optional(),
  schemaCandidates: z
    .array(
